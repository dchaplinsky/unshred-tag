...
from models import Shred, Tags, Taggable, TaggingSpeed, User, Pages
...
def create_shreds():
    ...
    fname = "fixtures/taggables.json"
    with open(fname, "r") as f:
        objs = json.load(f)
        for obj in objs:
            obj['object'] = Shred.objects.get(pk=obj['object'])
            Taggable.objects.create(**obj)
