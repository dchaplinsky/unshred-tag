...
def cnt_point_to_Point2(cnt_point):
    return Point2(*map(int, cnt_point))
...
def extract_piece_and_features(img, c, name):
    ...
    if defects is not None:
        ...
        # if has_defects:
        #     cv2.imwrite("debug/def_20_%s_%s.png" % (out_dir_name, name), mask)
...
# def disjoint_pieces(mask, contours):
#     pass
